Species_Daly_final_inters <- read.table('C:/Users/s2872641/Documents/Griffith_post_doc/Data_Daly/Species_Daly/Fish_Daly_final_inters.txt', header=TRUE, sep = ",")
Species_Daly_final_inters <- Species_Daly_final_inters[,c(2,5,59:103)]
...
mat <- matrix(0, ncol=46, nrow=865)
colnames(mat) <- 1:dim(mat)[2]
col_names <- colnames(dataset)
col_names[2] <- 'PU_ID'
col_names <- col_names[2:47]
...
write.table(agg_larger_areas,'C:/Users/s2872641/Documents/Griffith_post_doc/Data_Daly/Species_Daly/agg_fish_data.txt',sep = ",", col.names = NA)
